...
class MNISTM(Dataset):
    ...
    def __init__(self, train=True):
        ...
        self.mnist = datasets.MNIST(config.DATA_DIR / 'mnist', train=train, download=False)
        self.bsds = BSDS500()
    ...
    def __getitem__(self, i):
        ...
        patch = self._random_patch(bsds_image)  # 从bsd数据集上的图片中随机裁剪一块[28, 28]的小区域下来
...
if __name__ == "__main__":
    ...
    img1 = target_dataset[0][0]

    # 使用pytorch自带的转化函数
    # img = transforms.ToPILImage(mode='RGB')(img1)
    # img.show()
